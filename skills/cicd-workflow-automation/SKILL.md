...
- If detailed workflow patterns are required, open `assets/implementation-playbook.md`.
...
- `assets/implementation-playbook.md` for detailed workflow patterns and examples.
